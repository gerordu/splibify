...
https: //accounts.spotify.com/authorize
    ?
    response_type = code &
    client_id = 563 cf15307bb4a679c2337505b72650e &
    scope = user - top - read user - read - private user - library - readuser - library - modify playlist - read playlist - read - private playlist - read - collaborative playlist - modify - private playlist - modify - public &
    ...
    function login() {
        ...
        var set = {
            client_id: '25bff869271a472ea877c7aca857d5e1',
            redirect_uri: 'http://www.spotmybackup.com/login.html',
...
function authCallback(event) {
    if (event.origin !== "http://www.spotmybackup.com") {
